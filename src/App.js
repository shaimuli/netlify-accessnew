...
class App extends Component {
  render() {
    return (
      <div className="App">
        <GitHubCorner url={"https://github.com/shaimuli/netlify-accessnew"} />
        <header className="App-header">
          ...
          <h1 className="App-title">
            aaaaHow to use express.js with Netlify functions
          </h1>
        </header>

        <p className="App-intro">
          <h2>Choose shay an examplesdalkhjf;sadlkjhf</h2>
        </p>
      </div>
    );
  }
